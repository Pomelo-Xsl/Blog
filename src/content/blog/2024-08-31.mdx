...
就过了几天，我的 Fastrans 项目（ https://github.com/XieslCN/Fastrans ）又更新了两个版本，现在是 `v1.1.1`。（求个 star 谢谢！）

<LinkCard 
  title="Github 链接"
  desc="https://github.com/XieslCN/Fastrans"
  url="https://github.com/XieslCN/Fastrans"
/>
...
<Info>
    完整 CHANGELOG 文档：https://github.com/XieslCN/Fastrans/blob/master/CHANGELOG.md
</Info>
